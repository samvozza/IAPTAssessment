...
db.define_table('object',
		...
		comment = T("Owned quantity refers to the amount of item which you have in your possession. If you have at least 1 item, the item will be visible under 'Owned' tab.")),
