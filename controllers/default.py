...
def setup():
    ...
    db.object.insert(name="Object1",collection=1,price=33, category=2,quantity=5, tradable_quantity=4, wanted_quantity=1, description='asdfa sdfhadhfja dfha dfjah sjd fahd fja dfja sdjf')
    db.object.insert(name="Object1",collection=1,price=33, category=2,quantity=5, tradable_quantity=4, wanted_quantity=1, description='asdfa sdfhadhfja dfha dfjah sjd fahd fja dfja sdjf')
    db.object.insert(name="Object1",collection=1,price=33, category=2,quantity=5, tradable_quantity=4, wanted_quantity=1, description='asdfa sdfhadhfja dfha dfjah sjd fahd fja dfja sdjf')
    db.object.insert(name="Object1",collection=1,price=33, category=2,quantity=5, tradable_quantity=4, wanted_quantity=1, description='asdfa sdfhadhfja dfha dfjah sjd fahd fja dfja sdjf')
    db.object.insert(name="Object1",collection=1,price=33, category=2,quantity=5, tradable_quantity=4, wanted_quantity=1, description='asdfa sdfhadhfja dfha dfjah sjd fahd fja dfja sdjf')
